...
<body>
    ...
    <div id="content">
        ...
        <p><?php _e('Maintenance mode is enabled, due to lack of activity from logged-in users!', 'auto-maintenance-mode')?></p>
        <p><?php _e('To disable this message, please ', 'auto-maintenance-mode')?><strong><a href="<?php echo wp_login_url()?>"><?php _e('login now', 'auto-maintenance-mode'); ?></a></strong><?php _e(' or visit any page of this site using a browser where you have already logged-in!', 'auto-maintenance-mode')?></p>
